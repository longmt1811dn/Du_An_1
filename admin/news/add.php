<div class="admin-main_page">
    ...
    <form action="" class="form_add_news" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group-check">
            ...
            <div class="form-checkbox">
                ...
                <input value="1" type="radio" id="check1" name="highlights" data-on-label="On">

            </div>
            <div class="form-checkbox">
                <label for="check2" data-off-label="Off">Không nổi bật</label>
                <input value="0" type="radio" id="check2" name="highlights" data-on-label="On" checked>
        ...
        <div class="form-group-check">
            ...
            <div class="form-checkbox">
                ...
                <input value="1" type="radio" id="check1" name="hide" data-on-label="On" checked>

            </div>
            <div class="form-checkbox">
                <label for="check2" data-off-label="Off">Ẩn</label>
                <input value="0" type="radio" id="check2" name="hide" data-on-label="On">

            </div>
        </div>
        <div class="form-group-new-content">
            <label for="">Mô tả chi tiết </label>
            <textarea class="form-group__textarea" name="content" id="content" cols="1" rows="10" placeholder="Nội dung bài viết"></textarea>
        </div>
        <div style="width: 100%;" class="button-submit">
            <input type="hidden" name="id_user" value="<?= $_SESSION['login_id_admin'] ?>">
            <input type="submit" name="addnew" value="Thêm mới"></input>
